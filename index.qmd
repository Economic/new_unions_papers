...
This page displays a list of recent papers analyzing the effects of unions, sourced from [OpenAlex](https://openalex.org/), [NBER](https://www.nber.org/papers), and [IZA](https://www.iza.org/publications/dp).
  ...
  columns = list(
    ...
    journal = colDef(
      ...
      cell = function(value, index) {
        work_url = union_papers$doi[index]
